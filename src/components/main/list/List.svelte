<script lang="ts">
    ...
    import StudentListModify from "./StudentListModify.svelte";
    ...
    <table class="w-full border-collapse border border-default-color ">
        <thead class="bg-sub2">
            <tr class="hover-color">
                <th class=" border border-default-color p-2">과목</th>
        ...
        <tbody>
            {#each ListData as data}
                <tr class="hover-color">
                    <td class=" border border-default-color p-2">{data.subject}</td>
                    ...
                    <td class=" border border-default-color p-2 text-center">
                        <button on:click={() => openEvaluation(data.id)} class="cursor-pointer px-3 py-1 btn-action rounded-md">
                            풀기
                        </button>
                    </td>
                    <td class=" border border-default-color p-2 text-center">
